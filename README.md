...
> 截图展示手势识别实时追踪、法阵发光效果、AI 个性化解读与数据库历史记录页面。

**首页** · 开始占卜，右上角齿轮进入设置
![首页法阵](docs/page1.png)

**唤醒法阵** · 食指空中画圆，法阵随进度逐步发光点亮
![旋转法阵](docs/page2.png)

**手势选牌** · 移动手掌高亮待选牌面，握拳 3 秒选中
![选牌页面](docs/page3.png)

**AI 解读** · 翻牌后由 AI 结合数据库历史记录生成个性化解读
![AI解读](docs/page4.png)

**设置与历史** · 配置 OpenAI API Key，查看/删除数据库历史占卜记录
![设置页面](docs/page5.png)
